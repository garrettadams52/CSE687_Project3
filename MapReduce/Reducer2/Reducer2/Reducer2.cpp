// Reducer2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	std::string inFile = "\\sorted_aggregated_output2.txt";
	std::string outFile = "\\reduced_output2.txt";
